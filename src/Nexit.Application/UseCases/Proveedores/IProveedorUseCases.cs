...
public interface IActualizarProveedorUseCase { Task<ProveedorResponseDto> ExecuteAsync(UpdateProveedorDto input, CancellationToken cancellationToken = default); }
...
public interface IEliminarProveedorUseCase { Task ExecuteAsync(Guid id, CancellationToken cancellationToken = default); }
