...
public record EtapaClienteDto(Guid Id, string Nombre, short Orden, short PorcentajeProceso);
...
public record CrearEtapaClienteDto(string Nombre, short Orden, short PorcentajeProceso);
