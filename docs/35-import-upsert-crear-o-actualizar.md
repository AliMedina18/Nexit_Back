...
- ~~Esto se escribió y se verificó la lógica contra Postgres real, pero **no se compiló** el backend en sí~~ **Resuelto el 2026-09-08:** compila limpio y ahora tiene pruebas de verdad. Las pruebas de los tres importadores habían quedado escritas para los constructores viejos (3-4 parámetros) y el proyecto de pruebas **no compilaba** desde este cambio -- se actualizaron, y se agregaron 7 pruebas nuevas que cubren la rama de actualizar, que hasta ahora solo existía en la simulación de Python: reimportar actualiza en vez de duplicar; una celda en blanco conserva el valor previo; teléfono/correo repetidos no se duplican y uno nuevo se agrega sin borrar el anterior; los servicios de un proveedor y el gerente/equipo/proveedores de un proyecto sobreviven al reimportar; y "Pagado" en blanco no revierte un proyecto ya cobrado.
