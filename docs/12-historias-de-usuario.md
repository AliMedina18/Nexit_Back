...
2. El frontend arma el menú principal según ese rol:
   - **Cualquier rol** ve: Clientes, Proveedores, Proyectos. *(Calendario se eliminó el 2026-09-09, ver `docs/41`.)*
